...
<p align="center">
  <img src="https://files.catbox.moe/w5ykey.png" alt="Thumbnail" />
</p>
...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:hexarainsect/Hexara-Bail"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"kayzen\",\"url\":\"https://t.me/angkasanyabobo\"}"
      }
    ],
...
const thanksFor = async () => {
  const credit = new Map([
    ["angkasa", ""],
    ["olin", "source my fork"],
    ["hexara", "main source baileys ( maybe )"]
  ]);
