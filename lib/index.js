...
console.log(chalk.cyan.bold('║') + chalk.cyan.bold('                    © HEXARA INSECT                         ') + '║');
console.log(chalk.cyan.bold('╚══════════════════════════════════════════════════════════════╝\n'));

console.log(chalk.bold('🔰 H E X A R A - I N S E C T  5 . 0 . 0 B A I L S - B Y O M K A S A  🔰') + '\n');
console.log(chalk.bold('╭────────────────────────────────────────────────────────────╮'));
console.log(chalk.bold('│') + chalk.cyan.bold('        🚀 Bot is now online and ready to serve! 🚀          '));
console.log(chalk.bold('│') + chalk.cyan.bold('        ✨ Powered by Om Angkasa - MD API ✨                '));
console.log(chalk.bold('╰────────────────────────────────────────────────────────────╯') + '\n');

console.log(chalk.cyan.bold('                      HEXARA INSECT v5.0.0                      '));
console.log(chalk.cyan.bold('╭────────────────────────────────────────────────────────────╮'));
...
console.log(chalk.bold('│') + chalk.green.bold('              👑 Owner: angkasanyabobo'));
